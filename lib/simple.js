const { default: makeWASocket, proto, downloadContentFromMessage, getBinaryNodeChild, jidDecode, areJidsSameUser, generateForwardMessageContent, generateWAMessageFromContent } = require('@adiwajshing/baileys-md')
...
END:VCARD
   ...
   * @param {Object} options 
   */
   conn.sendButtonVid = async (jid, contentText, footer, buffer, buttons, quoted, options) => {
    const { proto, prepareWAMessageMedia } = require('@adiwajshing/baileys-md')
        ...
        hydratedTemplate: {
          ...
          hydratedButtons: [{
            urlButton: {
              ...
              url: 'https://github.com/SudoAnirudh/Eva-Md'
            }
          }, {
            urlButton: {
            ...
            urlButton: {
              displayText: 'Owner Whatsapp',
              url: 'https://wa.me/919539102851'
            }
          }, {
            urlButton: {
...
*/
 ...
 //button gif { video: buffer, gifPlayback: true}
  //========Ini Batas banh >//< =========//
