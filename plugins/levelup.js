...
let handler = async (m, { conn, usedPrefix }) => {
  ...
  try {
    ...
    if (!levelling.canLevelUp(user.level, user.exp, global.multiplier)) {
      let rank = 'https://api.lolhuman.xyz/api/rank?apikey=7187e9cee7fada1e3c47025c&img=${pp}&background=https://i.ibb.co/KhtRxwZ/dark.png&username=${name}&level=${user.level}&currentxp=${xp}&xpneed=${max - user.exp}'
        {
