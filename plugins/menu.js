...
const defaultMenu = {
          before: `*This bot is still in the development stage, if there is a feature error bug, please report it to the bot owner or developer*
%readmore`.trimStart(),
  header: '╭─「 *%category* 」',
